...
public abstract class RegistrationDeformer extends RegistrationTransformer{

   Matrix3d myF;
   Vector3d myPos;
   PolarDecomposition3d myPolarD;
   
   public RegistrationDeformer () {
      myF = new Matrix3d();
      myPos = new Vector3d();
   ...
   //-------------------------------------------------------------------------//
   // following code is copied from maspack.geometry.GeometryTransformer //
   //-------------------------------------------------------------------------//
