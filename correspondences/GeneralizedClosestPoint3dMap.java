...
public abstract class GeneralizedClosestPoint3dMap <C extends VertexToMeshCorrespondence> 
extends ClosestPoint3dMap <C> implements GeneralizedPointInjectiveMapFormulator{

   public GeneralizedClosestPoint3dMap () {
      super ();
   }
   ...
   public SparseBlockMatrix createSourceGeneralizeMatrix () {
      ...
      for(int i = 0; i < n; i++) {
         ...
         (VertexToMeshCorrespondence)getInfo (i);
